    ...
    },
    {
      ...
      content: JSON.stringify({
        ...
        hardRules: [
          ...
          "Opening scene text must be 2-3 short paragraphs in this order: (1) establish the place and atmosphere, (2) introduce the hook/conflict, (3) end on a present-moment prompt.",
          "Do not assume the player already knows names, factions, or hidden context; briefly anchor them naturally in narration.",
          "Do not present explicit menu-like choice lists to the player.",
          "Implied choices should be woven indirectly into narration, preserving player agency.",
        ],
      }),
    },
  ];
    ...
    },
    {
      ...
      content: JSON.stringify({
        ...
        instructions: [
          ...
          "Keep openingScene.text narrative-first: scene setup, then hook, then immediate present-moment tension.",
        ],
      }),
    },
  ];
